...
class MainSection extends Component {
    ...
    renderToggleAll(completedCount) {
        ...
        if (todos.length > 0) {
            return (<Checkbox className="toggle-all" style={{
                marginBottom: 10
            }} label="Toggle All" defaultChecked={completedCount === todos.length} onCheck={actions.completeAll}/>);
        }
    }
    ...
    render() {
        ...
        const completedCount = todos.reduce((count, todo) => todo.completed
            ? count + 1
            : count, 0);
